...
--
-- Host: localhost    Database: image_gallery_database
-- ------------------------------------------------------
...
CREATE TABLE `comment` (
  ...
  KEY `comment_image_idx` (`image_id`),
  KEY `user_commente_idx` (`user`),
  CONSTRAINT `comment_image` FOREIGN KEY (`image_id`) REFERENCES `image` (`ID`),
...
CREATE TABLE `containment` (
  ...
  CONSTRAINT `album_containing` FOREIGN KEY (`album_id`) REFERENCES `album` (`id`),
  CONSTRAINT `image_contained` FOREIGN KEY (`image_id`) REFERENCES `image` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('user1','mail1@polimi.it','pass1'),('user2','mail2@polimi.it','pass2'),('user3','mail3@polimi.it','pass3'),('user4','mail4@polimi.it','pass4'),('user5','mail5@polimi.it','pass5'),('user6','mail6@polimi.it','pass6');
...
-- Dump completed on 2022-06-01 17:13:18
